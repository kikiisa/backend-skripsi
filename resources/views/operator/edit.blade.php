            ...
            <div class="card-body">
                <form action="{{Route('operator.update',$data->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="{{$data->username }}" id="username" class="form-control" placeholder="Username">
                    </div>
                    <div class="form-group">
                        <label for="name" class="form-label">Nama Lengkap</label>
                        <input type="text" name="name" id="name" value="{{$data->name }}" class="form-control" placeholder="Your Name">
                    </div>
                    <div class="form-group">
                        <label for="email" class="form-label">Email</label>
                        <input type="text" name="email" value="{{$data->email }}" id="email" class="form-control" placeholder="Your Email">
                    </div>
