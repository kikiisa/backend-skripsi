                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ $item->judul }}</td>
                                <td>
                                    <img width="30" src="{{ asset($item->gambar) }}" alt="{{ $item->gambar }}">
                                </td>
                                <td>
                                    <form action="{{ Route('kategori.destroy', $item->id) }}" method="post">
                                        ...
                                        <button class="btn btn-danger"
                                            onclick="return confirm('Menghapus Data Kategori ? Menghapus Data Transaksi Lainya')"><i
                ...
                <form action="{{ route('kategori.store') }}" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Nama Kategori" name="judul" class="form-control">
                            </div>               
                            <div class="form-group">
